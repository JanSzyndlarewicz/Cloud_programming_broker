...
from notification_service.infrastructure.messaging.abstract import EventBus
...
class RabbitMQEventBus(EventBus):
    ...
    def start_subscription_in_thread(
        self, queue: str, callback: callable, exchange_type: str = "direct", routing_key: str = ""
    ):
        def subscription_thread():
            self.subscribe(queue, callback, exchange_type, routing_key)
